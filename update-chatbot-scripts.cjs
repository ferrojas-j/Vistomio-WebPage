...
// Find where translations object starts and ends
const startIdx = content.indexOf('const translations = {');
// Find the closing brace of translations
// We know it ends before "export default function ChatbotSimulator"
const endIdx = content.indexOf('export default function ChatbotSimulator');
...
content = content.substring(0, startIdx) + newTranslations + content.substring(endIdx);
